...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try { // 将指定的jsp文件编译成对应的.java文件和.class文件，放在 d:/java_proj/diytomcat/work/javaweb/org/apache/jsp 目录下
            Context context = new Context("/javaweb", "d:/java_proj/javaweb/web", null,true);
            File file = new File("d:/java_proj/javaweb/web/index.jsp");
